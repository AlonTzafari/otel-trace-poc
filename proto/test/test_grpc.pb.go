...
const (
	Test_Test_FullMethodName = "/test.Test/Test"
)
...
func (c *testClient) Test(ctx context.Context, in *TestReq, opts ...grpc.CallOption) (*TestRes, error) {
...
func (UnimplementedTestServer) Test(context.Context, *TestReq) (*TestRes, error) {
